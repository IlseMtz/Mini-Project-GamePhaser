window.onload = function() {
    ...
    imagenFondo.src = "/assets/loserScreen.png";
    ...
    imagenFondo.onload = function() {
        ...
        ctx.fillText("Juega de nuevo para volver a intentarlo", canvas.width / 2, canvas.height / 6 + 40);
        ...
        ctx.fillStyle = "#FFFFFF";
        ctx.textAlign = "center";
        ctx.fillText("Game Over", canvas.width / 2, canvas.height / 6 + 150);
    ...
    dragImageObj.src = "/assets/volverAIntentar.png";  // Ruta a imagen "sky.png"
